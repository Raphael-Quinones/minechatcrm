  ...
  return (
    <html lang={locale} suppressHydrationWarning>
      <head>
        ...
        <meta property="og:title" content="Minechat CRM" />
        <meta
          property="og:description"
          content="Minechat CRM is an open source CRM build on top of NextJS. Technology stack: NextJS with Typescrtipt, MongoDB, TailwindCSS, React, Prisma, shadCN, resend.com, react.email and more."
        />
        ...
        <meta name="twitter:title" content="Minechat CRM" />
        <meta
